...
#include "EnemySubFormationStrategy_Circle.generated.h"
...
// =========================================================================
// Enemy SubFormation Strategy - Circle
//
...
class TACTICALAI_API UEnemySubFormationStrategy_Circle : public UEnemySubFormationStrategy
{
	GENERATED_BODY()
...
private:
	// 円の半径。
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Enemy AI|SubFormation|Circle",
