...
// =========================================================================
// Enemy SubFormation Strategy - Line
//
...
class TACTICALAI_API UEnemySubFormationStrategy_Line : public UEnemySubFormationStrategy
{
	GENERATED_BODY()
...
private:
	// 슬롯 사이 간격.
	// スロット同士の間隔。
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Enemy AI|SubFormation|Line",
